...
C1_dash = [1/par.ms * [-par.ksf -par.csf -par.ksr 0 par.csf 0 par.csr];
           1/par.I *  [par.l1*par.ksf par.l1*par.csf -par.l2*par.ksr -par.l2*par.csr 0 -par.l1*par.csf 0 par.k2*par.csr];];

C = q*C1_dash;
E = Q * [[1/par.ms 1/par.ms];[-par.l1/I par.l2/par.I];];
